...
,
{
    ...
    whySofterDeveloper:'Thanks to programming and engineering having the instant feedback, I could continuously move forward in this world. If you don\'t go forward you gonna fall back',
...
,
{
    ...
    favoriteQuote:'If nothing changes,nothing changes.If you keep doing what you�re doing, your�re going to keep getting what you\'re getting.You want change,make some (By Courtney C.Stevens,The Lies About Truth)',
    joinedOn:'16/04/2018'
},
{   firstName:'Sravanthi ',
    lastName:'Bandaru',
    ...
    motivatesMe:'Learn from your mistakes,failure is not the opposite of success it�s part of success',
    favoriteQuote:'Be like yourself. It�s you alone can love and motivate yourself',
    joinedOn:'16.02.2018' },
...
{   firstName:'Dita',
    ...
    favoriteQuote:'Everything that happens happens for good, even when it doesn�t look like',
    joinedOn:'16.04.2018'
},
...
{   firstName:'Saidur ',
    ...
    whySofterDeveloper:'It�s challenging and it�s allows to explore one�s creativity',
...
{   firstName:'Rojak',
    ...
    favoriteQuote:'They told me : �Do something you love everyday, so I do coding� :P',
    joinedOn:'16.04.2018'
},
...
{   firstName:'Kushal',
    ...
    whySofterDeveloper:'Time and again suddenly my computer wouldn�t work, and then I had to use command prompt to fix it, and I started exploring more about it and loved how powerful that dark blinking rectangle was, wow now I am far from that but still exploring, now I come under the definition of software developer and yes I want to make my living out of it. ',
...
{   firstName:'Richard',
    ...
    favoriteQuote:'�Beware of false knowledge; it is more dangerous than ignorance.� George Bernard Shaw',
    joinedOn:'Aug. 2018'
},
{   firstName:'Jolene',
    lastName:'Hoang',
